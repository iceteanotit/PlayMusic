package com.example.playmusic.service;
...
import com.example.playmusic.controller.MediaController;
import com.example.playmusic.controller.MediaListener;
import com.example.playmusic.models.Song;
import com.example.playmusic.models.SoundInfo;
...
public class MP3Service extends Service implements MediaListener, Runnable {
    ...
    private void pushNotify() {
        ...
        views.setImageViewResource(R.id.im_play, controller.isPlaying() ? R.drawable.ic_pause : R.drawable.ic_play);
